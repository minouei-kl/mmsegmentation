...
data = dict(
    ...
    train=dict(
        ...
        ann_dir='/netscratch/minouei/versicherung/version5/annotations/train',
        pipeline=train_pipeline),
    val=dict(
        type='DRIVEDataset',
        img_dir='/netscratch/minouei/versicherung/version5/images/val',
        ann_dir='/netscratch/minouei/versicherung/version5/annotations/val',
...
work_dir = '/netscratch/minouei/versicherung/work_dirs/deeplabv3plus_r50-d8_704_b_80k_versicherung5'
gpu_ids = range(0, 1)
